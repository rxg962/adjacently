function gameStartMenu(){
     ...
     startmenuButtons.push(new startMenuButton(dailytxt, width/2 - buttonW/2, floor(2 * height/3 * (2/7)), buttonW, buttonH));
  
  startmenuButtons.push(new startMenuButton(infinitetxt, width/2 - buttonW/2,  floor(2 * height/3 * (5/7)), buttonW, buttonH));
